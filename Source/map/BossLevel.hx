...
import state.BossState;
/**
 * ...
 * @author Samuel Batista
 */
class BossLevel extends TiledMap
{
	...
	public function loadObjects(state:BossState)
	{
	...
	private function loadObject(o:TiledObject, g:TiledObjectGroup, state:BossState)
	{
		var x:Int = o.x;
		var y:Int = o.y;
		...
		switch (o.type.toLowerCase())
		{
			case "player_start":
				...
				//state.add(player.display);
				
				var player = new PetSkeleton(new FlxGroup(), 16 * 4);
				//player.play("stand");
