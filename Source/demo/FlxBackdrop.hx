package 
{
	...
	public class PlayState extends FlxState
	{
		...
		[Embed(source = 'assets/scrollTest.png')] private var background:Class;
		public var backscroll:FlxBackdrop; 
		
		override public function create():void
		{
			FlxG.framerate = 60;
			FlxG.flashFramerate = 60;
			backscroll = new FlxBackdrop(background, 0.8, 0.6, true, true);
			add(backscroll);
		}
